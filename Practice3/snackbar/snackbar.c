...
int main(void)
{
    // Function that stores menu and also will store what the customer selects
    add_items();

    // Prints out the Welcome board and menu
    ...
    while (true)
    {
        ...
        if (strlen(item) == 0) // Stop when it detects there is no input (aka when enter)
        {
            printf("\n");
            break;
        }
